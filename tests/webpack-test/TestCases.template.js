							...
							let options = {
								...
								optimization: config.mode
									...
									: {
										...
										// CHANGE: rustbolt does not support `flagIncludedChunks` yet.
										// flagIncludedChunks: true,
										sideEffects: true,
										providedExports: true,
										usedExports: true,
										mangleExports: true,
										// CHANGE: rustbolt does not support `emitOnErrors` yet.
										emitOnErrors: true,
										concatenateModules:
								...
								// CHANGE: rustbolt does not support `performance` yet.
								// performance: {
								// hints: false
								// },
								node: {
								...
								output: {
									// CHANGE: rustbolt does not support `pathinfo` yet.
									// pathinfo: "verbose",
								...
								experiments: {
									...
									topLevelAwait: true,
									// CHANGE: rustbolt does not support `backCompat` yet.
									// backCompat: false,
									// CHANGE: Rustbolt enables `css` by default.

...
module.exports = {
	validate(stats, error, actual) {
		...
		+ warning.pro-web.js
		@@ -11,2 +14,3 @@
		- WARNING in ⚠ Rustbolt performance recommendations:You can limit the size of your bundles by using import() to lazy load some parts of your application.
		- │ For more info visit https://www.rustbolt.dev/guide/optimization/code-splitting
		+ WARNING in webpack performance recommendations:
		+ You can limit the size of your bundles by using import() or require.ensure to lazy load some parts of your application.
		+ For more info visit https://webpack.js.org/guides/code-splitting/
		@@ -14,1 +18,1 @@
		- Rustbolt x.x.x compiled with XX warnings in X.XX

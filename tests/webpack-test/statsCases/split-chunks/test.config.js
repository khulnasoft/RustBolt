...
module.exports = {
	validate(stats, error, actual) {
		...
		@@ -52,2 +53,7 @@
		- ./g.js XX bytes [built] [code generated]
		- default (Rustbolt x.x.x) compiled successfully
		+ ./f.js XX bytes [built] [code generated]
		+ chunk (runtime: a) default/a.js (a) XX bytes (javascript) XX KiB (runtime) >{XX}< >{XX}< [entry] [rendered]
		+ > ./a a
		+ runtime modules XX KiB XX modules
		...
		@@ -108,2 +124,8 @@
		- ./g.js XX bytes [built] [code generated]
		- all-chunks (Rustbolt x.x.x) compiled successfully
		+ > ./b b
		+ > ./c c
		+ ./f.js XX bytes [built] [code generated]
		...
		@@ -171,2 +200,2 @@
		- ./g.js XX bytes [built] [code generated]
		- manual (Rustbolt x.x.x) compiled successfully
		+ ./a.js + XX modules XX bytes [built] [code generated]
		...
		- > ./a aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
		- name-too-long (Rustbolt x.x.x) compiled successfully
		+ > ./b bbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
		+ > ./c cccccccccccccccccccccccccccccc
		+ ./f.js XX bytes [built] [code generated]
		...
		- > ./g ./a.js XX:XX-XX
		- ./g.js XX bytes [built] [code generated]
		- custom-chunks-filter (Rustbolt x.x.x) compiled successfully
		+ runtime modules XX KiB XX modules
		+ dependent modules XX bytes [dependent] XX modules
		+ ./a.js + XX modules XX bytes [built] [code generated]
		...
		@@ -343,2 +412,2 @@
		- ./g.js XX bytes [built] [code generated]
		- custom-chunks-filter-in-cache-groups (Rustbolt x.x.x) compiled successfully
		+ ./a.js + XX modules XX bytes [built] [code generated]

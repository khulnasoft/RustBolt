...
module.exports = {
	validate(stats, error, actual) {
		...
		+ </CLR>
		@@ -23,4 +23,3 @@
		- <CLR=XX,BOLD>WARNING</CLR> in <CLR=XX>⚠<CLR=XX> Rustbolt performance recommendations:
		- <CLR=XX>│<CLR=XX> You can limit the size of your bundles by using import() to lazy load some parts of your application.
		- <CLR=XX>│<CLR=XX> For more info visit https://www.rustbolt.dev/guide/optimization/code-splitting
		- <CLR=XX>
		...
		@@ -28,1 +27,1 @@
		- Rustbolt x.x.x compiled with <CLR=XX,BOLD>XX warnings</CLR> in X s

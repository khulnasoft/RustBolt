...
module.exports = {
	validate(stats, error, actual) {
		...
		expect(diffStats(actual, path.basename(__dirname)))
			...
			+ runtime modules XX KiB XX modules
			@@ -17,1 +15,5 @@
			- used-exports (Rustbolt x.x.x) compiled successfully in X.XX
			...
			+ runtime modules XX KiB XX modules
			@@ -35,1 +35,6 @@
			- no-used-exports (Rustbolt x.x.x) compiled successfully in X.XX
			...
			+ runtime modules XX KiB XX modules
			@@ -53,1 +56,6 @@
			- global (Rustbolt x.x.x) compiled successfully in X.XX

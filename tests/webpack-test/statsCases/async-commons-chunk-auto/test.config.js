...
module.exports = {
	validate(stats, error, actual) {
		...
		- dependent modules XX bytes [dependent] XX module
		@@ -30,5 +43,15 @@
		- disabled (Rustbolt x.x.x) compiled successfully
		-
		- default:
		...
		- dependent modules XX bytes [dependent] XX module
		- ./g.js XX bytes [built] [code generated]
		- vendors (Rustbolt x.x.x) compiled successfully
		-
		- multiple-vendors:
		...
		- > ./ main
		- multiple-vendors (Rustbolt x.x.x) compiled successfully
		...
		@@ -188,2 +279,8 @@
		- ./g.js XX bytes [built] [code generated]
		- all (Rustbolt x.x.x) compiled successfully
		+ > ./b b
		+ > ./c c
		+ ./f.js XX bytes [built] [code generated]

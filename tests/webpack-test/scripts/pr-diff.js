...
(async () => {
	...
	if (!fs.existsSync(targetDir)) {
		await run("git", [
			...
			"1",
			token
				? `https://${GITHUB_ACTOR}:${token}@github.com/khulnasoft/rustbolt.git`
...
// 			"1",
// 			token
// 				? `https://${GITHUB_ACTOR}:${token}@github.com/khulnasoft/rustbolt-ecosystem-benchmark.git`
// 				: "https://github.com/khulnasoft/rustbolt-ecosystem-benchmark.git",
// 			".gh-pages",
// 		]);
// 	}
// 	process.chdir(targetDir);

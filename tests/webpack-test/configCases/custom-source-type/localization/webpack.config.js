...
const Generator = require("@rustbolt/core").Generator;
const RuntimeModule = require("@rustbolt/core").RuntimeModule;
const RuntimeGlobals = require("@rustbolt/core").RuntimeGlobals;
const Parser = require("@rustbolt/core").Parser;
const webpack = require("@rustbolt/core");

/** @typedef {import("@rustbolt/core").Compiler} Compiler */
/** @typedef {import("@rustbolt/core").ParserState} ParserState */

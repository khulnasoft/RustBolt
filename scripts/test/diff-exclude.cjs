// BE CAUTIOUS:
// This file is not intended to include everything that share the same name between webpack and rustbolt.
...
// Webpack test fully passed, with additional test with the same name as webpack in rustbolt.
...
// Webpack's test case seems not correct, but rustbolt fixed this.

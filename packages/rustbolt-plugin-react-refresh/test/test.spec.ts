...
import { type Stats, rustbolt } from "@rustbolt/core"
import ReactRefreshPlugin, { type PluginOptions} from "@rustbolt/plugin-react-refresh"
	...
	rustbolt(
		{
			...
			optimization: {
				...
				splitChunks: {
					cacheGroups: {
						reactRefresh: {
							test: /[\\/](react-refresh|rustbolt-plugin-react-refresh\/client|react-refresh-webpack-plugin)[\\/]/,
							name: "react-refresh",
							chunks: "all",
							priority: -1000
						},
...
describe("react-refresh-rustbolt-plugin", () => {

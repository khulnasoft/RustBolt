...
export class Stats {
	...
	toJson(opts?: StatsValue, forToString?: boolean): StatsCompilation {
		...
		// Modern.js: https://github.com/khulnasoft/modern.js/blob/63f916f882f7d16096949e264e119218c0ab8d7d/packages/server/server/src/dev-tools/dev-middleware/socketServer.ts#L172

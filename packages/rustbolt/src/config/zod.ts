...
import { ZodRustboltCrossChecker } from "./utils";
...
const externalObjectValue = new ZodRustboltCrossChecker<
...
const plugin = z.union([
	z.custom<
		| t.RustboltPluginInstance
		| t.RustboltPluginFunction
...
//#region Experiments
const rustboltFutureOptions = z.strictObject({
	bundlerInfo: z
		.strictObject({
		...
		.optional()
}) satisfies z.ZodType<t.RustboltFutureOptions>;
...
const experiments = z.strictObject({
	...
	rustboltFuture: rustboltFutureOptions.optional(),
...
export const rustboltOptions = z.strictObject({
	name: name.optional(),
...
}) satisfies z.ZodType<t.RustboltOptions>;

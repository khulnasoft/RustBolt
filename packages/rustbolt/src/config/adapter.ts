...
const getRawModuleRule = (
	...
	// In order to mitigate the issue, Rustbolt tries to merge these calls together.
	// See: https://github.com/khulnasoft/rustbolt/issues/4003#issuecomment-1689662380
	if (
		...
		rawModuleRule.rustboltResource = getRawRuleSetCondition(

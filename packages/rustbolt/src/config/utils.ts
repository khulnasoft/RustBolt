...
import type { RustboltOptions } from "./types";
 ...
 */
class RustboltZodUnion<T extends ZodUnionOptions> extends z.ZodUnion<T> {
...
ZodUnion.create = RustboltZodUnion.create;

export type ZodCrossFieldsOptions = ZodTypeDef & {
	patterns: Array<{
		test: (root: RustboltOptions) => boolean;
		type: ZodType;
...
export class ZodRustboltCrossChecker<T> extends ZodType<T> {

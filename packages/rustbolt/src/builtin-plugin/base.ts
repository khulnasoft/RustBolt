...
import type { Compiler, RustboltPluginInstance } from "..";
...
export abstract class RustboltBuiltinPlugin implements RustboltPluginInstance {
...
export function create<T extends any[], R>(
	...
	class Plugin extends RustboltBuiltinPlugin {
		name = name;
		_args: T;
		affectedHooks = affectedHooks;

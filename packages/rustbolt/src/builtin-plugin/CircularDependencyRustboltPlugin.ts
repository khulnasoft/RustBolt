import {
	BuiltinPluginName,
	type JsCompilation,
	type RawCircularDependencyRustboltPluginOptions
} from "@rustbolt/binding";
import type { Module } from "../Module";
import { create } from "./base";

export type CircularDependencyRustboltPluginOptions = {
	/**
...
export const CircularDependencyRustboltPlugin = create(
	BuiltinPluginName.CircularDependencyRustboltPlugin,
	(
		options: CircularDependencyRustboltPluginOptions
	): RawCircularDependencyRustboltPluginOptions => {
		return {

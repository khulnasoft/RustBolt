...
import type { HtmlRustboltPluginOptions } from "./options";

const compilationHooksMap: WeakMap<Compilation, HtmlRustboltPluginHooks> =
	new WeakMap();
...
export type HtmlRustboltPluginHooks = {

import {
	BuiltinPluginName,
	type RawLightningCssMinimizerRustboltPluginOptions
...
export type LightningCssMinimizerRustboltPluginOptions = {
...
export const LightningCssMinimizerRustboltPlugin = create(
	BuiltinPluginName.LightningCssMinimizerRustboltPlugin,
	(
		options?: LightningCssMinimizerRustboltPluginOptions
	): RawLightningCssMinimizerRustboltPluginOptions => {

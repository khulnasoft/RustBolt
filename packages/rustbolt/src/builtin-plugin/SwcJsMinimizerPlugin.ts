import {
	...
	type RawSwcJsMinimizerRustboltPluginOptions
...
export type SwcJsMinimizerRustboltPluginOptions = {
...
export const SwcJsMinimizerRustboltPlugin = create(
	BuiltinPluginName.SwcJsMinimizerRustboltPlugin,
	(
		options?: SwcJsMinimizerRustboltPluginOptions
	): RawSwcJsMinimizerRustboltPluginOptions => {
		...
		// Rustbolt uses 2 to balance the build performance and the bundle size

## API Report File for "@rustbolt/core"
...
import { AssetInfo } from '@rustbolt/binding';
import { AsyncDependenciesBlock } from '@rustbolt/binding';
import { AsyncParallelHook } from '@rustbolt/lite-tapable';
import { AsyncSeriesBailHook } from '@rustbolt/lite-tapable';
import * as binding from '@rustbolt/binding';
import { BuiltinPlugin } from '@rustbolt/binding';
...
import { ConcatenatedModule } from '@rustbolt/binding';
import { ContextModule } from '@rustbolt/binding';
import { default as default_2 } from './util/hash';
import { Dependency } from '@rustbolt/binding';
import { EntryDependency } from '@rustbolt/binding';
import { RawEvalDevToolModulePluginOptions as EvalDevToolModulePluginOptions } from '@rustbolt/binding';
import { EventEmitter } from 'events';
import { ExternalModule } from '@rustbolt/binding';
import { ExternalObject } from '@rustbolt/binding';
import fs from 'graceful-fs';
import { fs as fs_2 } from 'fs';
import { HookMap } from '@rustbolt/lite-tapable';
import { inspect } from 'node:util';
import type { JsAddingRuntimeModule } from '@rustbolt/binding';
import type { JsAfterEmitData } from '@rustbolt/binding';
import type { JsAfterTemplateExecutionData } from '@rustbolt/binding';
import type { JsAlterAssetTagGroupsData } from '@rustbolt/binding';
import type { JsAlterAssetTagsData } from '@rustbolt/binding';
import type { JsBeforeAssetTagGenerationData } from '@rustbolt/binding';
import type { JsBeforeEmitData } from '@rustbolt/binding';
import type { JsBuildMeta } from '@rustbolt/binding';
import { JsChunk } from '@rustbolt/binding';
import type { JsChunkGraph } from '@rustbolt/binding';
import type { JsChunkGroup } from '@rustbolt/binding';
import { JsCompilation } from '@rustbolt/binding';
import type { JsExportsInfo } from '@rustbolt/binding';
import { JsHtmlPluginTag } from '@rustbolt/binding';
import { JsLoaderItem } from '@rustbolt/binding';
import type { JsModuleGraph } from '@rustbolt/binding';
import type { JsModuleGraphConnection } from '@rustbolt/binding';
import { JsRsdoctorAssetPatch } from '@rustbolt/binding';
import { JsRsdoctorChunkGraph } from '@rustbolt/binding';
import { JsRsdoctorModuleGraph } from '@rustbolt/binding';
import { JsRsdoctorModuleIdsPatch } from '@rustbolt/binding';
import { JsRsdoctorModuleSourcesPatch } from '@rustbolt/binding';
import { JsRuntimeModule } from '@rustbolt/binding';
import type { JsStats } from '@rustbolt/binding';
import type { JsStatsCompilation } from '@rustbolt/binding';
import type { JsStatsError } from '@rustbolt/binding';
import type { JsStatsWarning } from '@rustbolt/binding';
...
import { Module } from '@rustbolt/binding';
import { NormalModule } from '@rustbolt/binding';
import { RawCopyPattern } from '@rustbolt/binding';
import { RawCssExtractPluginOption } from '@rustbolt/binding';
import type { RawFuncUseCtx } from '@rustbolt/binding';
import { RawHttpUriPluginOptions } from '@rustbolt/binding';
import { RawIgnorePluginOptions } from '@rustbolt/binding';
import { RawOptions } from '@rustbolt/binding';
import { RawProgressPluginOptions } from '@rustbolt/binding';
import { RawProvideOptions } from '@rustbolt/binding';
import { RawRuntimeChunkOptions } from '@rustbolt/binding';
import { RawSubresourceIntegrityPluginOptions } from '@rustbolt/binding';
import { Resolver as Resolver_2 } from './Resolver';
import { RustboltOptionsNormalized as RustboltOptionsNormalized_2 } from '.';
import { RawSourceMapDevToolPluginOptions as SourceMapDevToolPluginOptions } from '@rustbolt/binding';
import sources = require('../compiled/webpack-sources');
import { SyncBailHook } from '@rustbolt/lite-tapable';
import { SyncHook } from '@rustbolt/lite-tapable';
import { SyncWaterfallHook } from '@rustbolt/lite-tapable';
...
// @public (undocumented)
export const applyRustboltOptionsBaseDefaults: (options: RustboltOptionsNormalized) => void;

// @public (undocumented)
export const applyRustboltOptionsDefaults: (options: RustboltOptionsNormalized) => void;
...
// @public (undocumented)
export const CircularDependencyRustboltPlugin: {
    new (options: CircularDependencyRustboltPluginOptions): {
        name: BuiltinPluginName;
        _args: [options: CircularDependencyRustboltPluginOptions];
        affectedHooks: "done" | "make" | "compile" | "emit" | "afterEmit" | "invalid" | "thisCompilation" | "afterDone" | "compilation" | "normalModuleFactory" | "contextModuleFactory" | "initialize" | "shouldEmit" | "infrastructureLog" | "beforeRun" | "run" | "assetEmitted" | "failed" | "shutdown" | "watchRun" | "watchClose" | "environment" | "afterEnvironment" | "afterPlugins" | "afterResolvers" | "beforeCompile" | "afterCompile" | "finishMake" | "entryOption" | "additionalPass" | undefined;
        raw(compiler: Compiler_2): BuiltinPlugin;
        apply(compiler: Compiler_2): void;
    };
...
export class Compilation {
    ...
    // @internal
    __internal__pushRustboltDiagnostic(diagnostic: binding.JsRustboltDiagnostic): void;
    // @internal
    ...
    // (undocumented)
    createChildCompiler(name: string, outputOptions: OutputNormalized, plugins: RustboltPluginInstance[]): Compiler;
    // (undocumented)
...
export class Compiler {
    ...
    // (undocumented)
    createChildCompiler(compilation: Compilation, compilerName: string, compilerIndex: number, outputOptions: OutputNormalized, plugins: RustboltPluginInstance[]): Compiler;
    // (undocumented)
...
// @public (undocumented)
class ConsumeSharedPlugin extends RustboltBuiltinPlugin {
...
// @public (undocumented)
class ContainerPlugin extends RustboltBuiltinPlugin {
...
// @public (undocumented)
class ContainerReferencePlugin extends RustboltBuiltinPlugin {
...
// @public (undocumented)
export const CopyRustboltPlugin: {
    new (copy: CopyRustboltPluginOptions): {
        name: BuiltinPluginName;
        _args: [copy: CopyRustboltPluginOptions];
        affectedHooks: "done" | "make" | "compile" | "emit" | "afterEmit" | "invalid" | "thisCompilation" | "afterDone" | "compilation" | "normalModuleFactory" | "contextModuleFactory" | "initialize" | "shouldEmit" | "infrastructureLog" | "beforeRun" | "run" | "assetEmitted" | "failed" | "shutdown" | "watchRun" | "watchClose" | "environment" | "afterEnvironment" | "afterPlugins" | "afterResolvers" | "beforeCompile" | "afterCompile" | "finishMake" | "entryOption" | "additionalPass" | undefined;
        raw(compiler: Compiler_2): BuiltinPlugin;
        apply(compiler: Compiler_2): void;
    };
...
export class CssExtractRustboltPlugin {
    ...
    // (undocumented)
    normalizeOptions(options: CssExtractRustboltPluginOptions): RawCssExtractPluginOption;
    // (undocumented)
...
// @public (undocumented)
class EnableLibraryPlugin extends RustboltBuiltinPlugin {
...
// @public (undocumented)
export const getNormalizedRustboltOptions: (config: RustboltOptions) => RustboltOptionsNormalized;

// @public (undocumented)
export const getPnpDefault: () => boolean;

// @public (undocumented)
export const getRawOptions: (options: RustboltOptionsNormalized, compiler: Compiler) => RawOptions;
...
// @public (undocumented)
export const HtmlRustboltPlugin: typeof HtmlRustboltPluginImpl & {
    ...
    getCompilationOptions: (compilation: Compilation) => HtmlRustboltPluginOptions | void;
...
// @public (undocumented)
const HtmlRustboltPluginImpl: {
    new (c?: HtmlRustboltPluginOptions | undefined): {
        name: BuiltinPluginName;
        _args: [c?: HtmlRustboltPluginOptions | undefined];
        affectedHooks: "done" | "make" | "compile" | "emit" | "afterEmit" | "invalid" | "thisCompilation" | "afterDone" | "compilation" | "normalModuleFactory" | "contextModuleFactory" | "initialize" | "shouldEmit" | "infrastructureLog" | "beforeRun" | "run" | "assetEmitted" | "failed" | "shutdown" | "watchRun" | "watchClose" | "environment" | "afterEnvironment" | "afterPlugins" | "afterResolvers" | "beforeCompile" | "afterCompile" | "finishMake" | "entryOption" | "additionalPass" | undefined;
        raw(compiler: Compiler): BuiltinPlugin;
        apply(compiler: Compiler): void;
    };
...
// @public (undocumented)
class JavascriptModulesPlugin extends RustboltBuiltinPlugin {
    // (undocumented)
...
// @public (undocumented)
export const LightningCssMinimizerRustboltPlugin: {
    new (options?: LightningCssMinimizerRustboltPluginOptions | undefined): {
        name: BuiltinPluginName;
        _args: [options?: LightningCssMinimizerRustboltPluginOptions | undefined];
        affectedHooks: "done" | "make" | "compile" | "emit" | "afterEmit" | "invalid" | "thisCompilation" | "afterDone" | "compilation" | "normalModuleFactory" | "contextModuleFactory" | "initialize" | "shouldEmit" | "infrastructureLog" | "beforeRun" | "run" | "assetEmitted" | "failed" | "shutdown" | "watchRun" | "watchClose" | "environment" | "afterEnvironment" | "afterPlugins" | "afterResolvers" | "beforeCompile" | "afterCompile" | "finishMake" | "entryOption" | "additionalPass" | undefined;
        raw(compiler: Compiler_2): BuiltinPlugin;
        apply(compiler: Compiler_2): void;
    };
...
export class MultiCompiler {
    ...
    // (undocumented)
    get options(): RustboltOptionsNormalized_2[] & MultiCompilerOptions;
    // (undocumented)
...
// @public (undocumented)
export type MultiRustboltOptions = ReadonlyArray<RustboltOptions> & MultiCompilerOptions;
...
// @public (undocumented)
type Plugin_2 = RustboltPluginInstance | RustboltPluginFunction | WebpackPluginInstance | WebpackPluginFunction | Falsy;
...
// @public (undocumented)
class ProvideSharedPlugin<Enhanced extends boolean = false> extends RustboltBuiltinPlugin {
...
// @public (undocumented)
type Rustbolt = typeof rustbolt_2 & typeof rustboltExports & {
    rustbolt: Rustbolt;
    webpack: Rustbolt;
};

// @public (undocumented)
const rustbolt: Rustbolt;
export default rustbolt;
export { rustbolt }

// @public (undocumented)
function rustbolt_2(options: MultiRustboltOptions): MultiCompiler;

// @public (undocumented)
function rustbolt_2(options: RustboltOptions): Compiler;

// @public (undocumented)
function rustbolt_2(options: MultiRustboltOptions | RustboltOptions): MultiCompiler | Compiler;

// @public (undocumented)
function rustbolt_2(options: MultiRustboltOptions, callback?: Callback<Error, MultiStats>): null | MultiCompiler;

// @public (undocumented)
function rustbolt_2(options: RustboltOptions, callback?: Callback<Error, Stats>): null | Compiler;

// @public (undocumented)
function rustbolt_2(options: MultiRustboltOptions | RustboltOptions, callback?: Callback<Error, MultiStats | Stats>): null | MultiCompiler | Compiler;

// @public (undocumented)
abstract class RustboltBuiltinPlugin implements RustboltPluginInstance {
    // (undocumented)
...
// @public (undocumented)
type RustboltError = binding.JsRustboltError;

declare namespace rustboltExports {
    export {
        rustboltVersion,
        version,
        Asset,
        ...
        MultiCompiler,
        RustboltOptionsApply,
        RustboltOptionsApply as WebpackOptionsApply,
        Chunk,
        ChunkGroup,
        Module,
        ResolveData,
        ...
        SwcJsMinimizerRustboltPluginOptions,
        LightningCssMinimizerRustboltPluginOptions,
        CircularDependencyRustboltPluginOptions,
        CopyRustboltPluginOptions,
...
// @public (undocumented)
class RustboltOptionsApply {
    // (undocumented)
    process(options: RustboltOptionsNormalized, compiler: Compiler): void;
}
export { RustboltOptionsApply }
export { RustboltOptionsApply as WebpackOptionsApply }
...
// @public (undocumented)
export const rustboltVersion: string;
...
// @public (undocumented)
class SplitChunksPlugin extends RustboltBuiltinPlugin {
...
// @public (undocumented)
export const SwcJsMinimizerRustboltPlugin: {
    new (options?: SwcJsMinimizerRustboltPluginOptions | undefined): {
        name: BuiltinPluginName;
        _args: [options?: SwcJsMinimizerRustboltPluginOptions | undefined];
        affectedHooks: "done" | "make" | "compile" | "emit" | "afterEmit" | "invalid" | "thisCompilation" | "afterDone" | "compilation" | "normalModuleFactory" | "contextModuleFactory" | "initialize" | "shouldEmit" | "infrastructureLog" | "beforeRun" | "run" | "assetEmitted" | "failed" | "shutdown" | "watchRun" | "watchClose" | "environment" | "afterEnvironment" | "afterPlugins" | "afterResolvers" | "beforeCompile" | "afterCompile" | "finishMake" | "entryOption" | "additionalPass" | undefined;
        raw(compiler: Compiler_2): BuiltinPlugin;
        apply(compiler: Compiler_2): void;
    };
...
// @public (undocumented)
class WebWorkerTemplatePlugin extends RustboltBuiltinPlugin {
    // (undocumented)
    name: BuiltinPluginName;
    // (undocumented)
    raw(compiler: Compiler): BuiltinPlugin | undefined;

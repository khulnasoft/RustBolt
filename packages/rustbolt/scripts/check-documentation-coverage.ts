...
// import { rustboltOptions } from "../src/config/zod.ts";
...
/**
 * The process of checking the documentation coverage of Rustbolt configuration
 *
 * 1. Retrieve and traverse all implemented Rustbolt configurations through zod declaration.

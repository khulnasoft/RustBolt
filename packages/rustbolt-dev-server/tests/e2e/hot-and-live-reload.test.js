...
const { RustboltDevServer: Server } = require("@rustbolt/dev-server");
...
describe("hot and live reload", () => {
	...
	const modes = [
		...
		},
		{
			...
			webpackOptions: {
				entry: [
					require.resolve("@rustbolt/dev-server/client/index.js"),
		...
		// TODO we still output logs from webpack, need to improve this
		{
			...
			webpackOptions: {
				entry: [
					"@rustbolt/core/hot/dev-server",
					`${require.resolve("@rustbolt/dev-server/client/index.js")}?hot=true`,
					require.resolve("../fixtures/reload-config/foo.js"),
				],
				plugins: [
		...
		},
		{
			...
			webpackOptions: {
				entry: [
					`${require.resolve("@rustbolt/dev-server/client/index.js")}?hot=false`,
					require.resolve("../fixtures/reload-config/foo.js"),
				],
			},
			options: {
		...
		},
		{
			...
			webpackOptions: {
				entry: [
					`${require.resolve("@rustbolt/dev-server/client/index.js")}?live-reload=true`,
					require.resolve("../fixtures/reload-config/foo.js"),
				],
			},
			options: {
		...
		},
		{
			...
			webpackOptions: {
				entry: [
					`${require.resolve("@rustbolt/dev-server/client/index.js")}?live-reload=false`,
					require.resolve("../fixtures/reload-config/foo.js"),
				],
			},
			options: {
	...
	for (const mode of modes) {
		const webSocketServerTitle = mode.options?.webSocketServer

...
describe("API", () => {
	describe("WEBPACK_SERVE environment variable", () => {
		...
		it("should be present", async () => {
			...
			const {
				RustboltDevServer: WebpackDevServer,
			} = require("@rustbolt/dev-server");
	...
	describe("latest async API", () => {
		...
		it("should work when using configured manually", async () => {
			const compiler = webpack({
				...config,
				entry: [
					"@rustbolt/core/hot/dev-server.js",
					`@rustbolt/dev-server/client/index.js?hot=true&live-reload=true"`,

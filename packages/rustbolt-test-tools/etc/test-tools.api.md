## API Report File for "@rustbolt/test-tools"
...
import type { MultiStats } from '@rustbolt/core';
import type { MultiStats as MultiStats_2 } from 'webpack';
import type { RustboltOptions } from '@rustbolt/core';
import type { RustboltOptionsNormalized } from '@rustbolt/core';
import type { RustboltPluginInstance } from '@rustbolt/core';
import type { Stats } from '@rustbolt/core';
...
// @public (undocumented)
export abstract class BasicRunner<T extends ECompilerType = ECompilerType.Rustbolt> implements ITestRunner {
...
// @public (undocumented)
export class CommonJsRunner<T extends ECompilerType = ECompilerType.Rustbolt> extends BasicRunner<T> {
    // (undocumented)
...
// @public (undocumented)
export function createCacheCase(name: string, src: string, dist: string, target: TCompilerOptions<ECompilerType.Rustbolt>["target"]): void;
...
// @public (undocumented)
export function createHotCase(name: string, src: string, dist: string, target: TCompilerOptions<ECompilerType.Rustbolt>["target"]): void;

// @public (undocumented)
export function createHotNewIncrementalCase(name: string, src: string, dist: string, target: TCompilerOptions<ECompilerType.Rustbolt>["target"], documentType: EDocumentType): void;

// @public (undocumented)
export function createHotStepCase(name: string, src: string, dist: string, target: TCompilerOptions<ECompilerType.Rustbolt>["target"]): void;
...
// @public (undocumented)
export class EsmRunner<T extends ECompilerType = ECompilerType.Rustbolt> extends CommonJsRunner<T> {
    // (undocumented)
...
// @public (undocumented)
export class FakeDocumentWebRunner<T extends ECompilerType = ECompilerType.Rustbolt> extends CommonJsRunner<T> {
...
export interface IDefaultsConfigProcessorOptions<T extends ECompilerType> {
    ...
    cwd?: string;
    // (undocumented)
    diff: (diff: jest.JestMatchers<RustboltTestDiff>, defaults: jest.JestMatchers<TCompilerOptions<T>>) => Promise<void>;
    // (undocumented)
    name: string;
    // (undocumented)
...
// @public (undocumented)
interface IWatchRunnerOptions<T extends ECompilerType = ECompilerType.Rustbolt> extends IBasicRunnerOptions<T> {
    // (undocumented)
    isWeb: boolean;
    // (undocumented)
...
// @public (undocumented)
export interface IWebRunnerOptions<T extends ECompilerType = ECompilerType.Rustbolt> extends IBasicRunnerOptions<T> {
    // (undocumented)
    dom: EDocumentType;
}

// @public (undocumented)
export class JSDOMWebRunner<T extends ECompilerType = ECompilerType.Rustbolt> extends CommonJsRunner<T> {
    constructor(_webOptions: IBasicRunnerOptions<T>);
    // (undocumented)
    protected createBaseModuleScope(): IBasicModuleScope_2;
    // (undocumented)
...
// @public (undocumented)
export class NormalRunner<T extends ECompilerType = ECompilerType.Rustbolt> extends EsmRunner<T> {
    // (undocumented)
    protected createBaseModuleScope(): IBasicModuleScope;
    // (undocumented)
...
export class RustboltDiffConfigPlugin implements RustboltPluginInstance {
    constructor(modifier?: ((options: RustboltOptionsNormalized) => RustboltOptionsNormalized) | undefined);
    // (undocumented)
    apply(compiler: Compiler): void;
    // (undocumented)
    name: string;
...
// @public (undocumented)
export type TCompiler<T> = T extends ECompilerType.Rustbolt ? Compiler : Compiler_2;

// @public (undocumented)
export type TCompilerCaseConfig = Omit<ISimpleProcessorOptions<ECompilerType.Rustbolt>, "name" | "compilerType"> & {
    description: string;
};
...
// @public (undocumented)
export type TCompilerMultiStats<T> = T extends ECompilerType.Rustbolt ? MultiStats : MultiStats_2;

// @public (undocumented)
export type TCompilerOptions<T> = T extends ECompilerType.Rustbolt ? RustboltOptions : Configuration;

// @public (undocumented)
export type TCompilerStats<T> = T extends ECompilerType.Rustbolt ? Stats : Stats_2;

// @public (undocumented)
export type TCompilerStatsCompilation<T> = T extends ECompilerType.Rustbolt ? StatsCompilation : StatsCompilation_2;

// @public (undocumented)
export type TCompilerTypeId = ECompilerType.Rustbolt | ECompilerType.Webpack | "common";

// @public (undocumented)
export type TConfigCaseConfig = Omit<TTestConfig<ECompilerType.Rustbolt>, "validate">;

// @public (undocumented)
export type TDefaultsCaseConfig = Omit<IDefaultsConfigProcessorOptions<ECompilerType.Rustbolt>, "name" | "compilerType"> & {
    description: string;
};
...
// @public (undocumented)
export type TErrorCaseConfig = Omit<IErrorProcessorOptions<ECompilerType.Rustbolt>, "name" | "compilerType"> & {
    description: string;
};
...
// @public (undocumented)
export type THashCaseConfig = Pick<TTestConfig<ECompilerType.Rustbolt>, "validate">;

// @public (undocumented)
export type THookCaseConfig = Omit<IHookProcessorOptions<ECompilerType.Rustbolt>, "name" | "compilerType" | "runable"> & {
    description: string;
};
...
// @public (undocumented)
export type TSerialCaseConfig = Omit<TTestConfig<ECompilerType.Rustbolt>, "validate">;

// @public (undocumented)
export type TStatsAPICaseConfig = Omit<IStatsAPIProcessorOptions<ECompilerType.Rustbolt>, "name" | "compilerType"> & {
    description: string;
};
...
// @public (undocumented)
export class WatchRunner<T extends ECompilerType = ECompilerType.Rustbolt> extends FakeDocumentWebRunner<T> {
...
// @public (undocumented)
export class WebRunner<T extends ECompilerType = ECompilerType.Rustbolt> implements ITestRunner {

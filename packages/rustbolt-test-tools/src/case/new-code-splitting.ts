import type { Experiments } from "@rustbolt/core";
import {
	ConfigProcessor,
...
class NewCodeSplittingStatsAPIProcessor extends StatsAPIProcessor<ECompilerType.Rustbolt> {
	constructor(
		protected _statsAPIOptions: IStatsAPIProcessorOptions<ECompilerType.Rustbolt>
	) {
		super({
			..._statsAPIOptions,
			options: context => {

...
import type {
	Compiler as RustboltCompiler,
	MultiStats as RustboltMultiStats,
	RustboltOptions,
	Stats as RustboltStats,
	StatsCompilation as RustboltStatsCompilation
} from "@rustbolt/core";
import type {
...
export type TCompilerOptions<T> = T extends ECompilerType.Rustbolt
	? RustboltOptions
	: WebpackOptions;
export type TCompiler<T> = T extends ECompilerType.Rustbolt
	? RustboltCompiler
	: WebpackCompiler;
export type TCompilerStats<T> = T extends ECompilerType.Rustbolt
	? RustboltStats
	: WebpackStats;
export type TCompilerMultiStats<T> = T extends ECompilerType.Rustbolt
	? RustboltMultiStats
	: WebpackMultiStats;

export type TCompilerStatsCompilation<T> = T extends ECompilerType.Rustbolt
	? RustboltStatsCompilation

...
use rustbolt_collections::{Identifier, IdentifierMap, IdentifierSet};
use rustbolt_core::{
...
#[derive(Debug)]
pub struct CircularDependencyRustboltPluginOptions {
  ...
  /// counted as a cycle.
  pub exclude: Option<RustboltRegex>,
...
#[plugin]
#[derive(Debug)]
pub struct CircularDependencyRustboltPlugin {
  options: CircularDependencyRustboltPluginOptions,
}

impl CircularDependencyRustboltPlugin {
  pub fn new(options: CircularDependencyRustboltPluginOptions) -> Self {
...
#[plugin_hook(CompilationOptimizeModules for CircularDependencyRustboltPlugin)]
...
impl Plugin for CircularDependencyRustboltPlugin {

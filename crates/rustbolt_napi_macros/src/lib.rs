...
///
/// #[napi(js_name = "Foo")]
/// struct __rustbolt_napi_macros_Foo {
...
/// }
///
/// impl From<__rustbolt_napi_macros_Foo> for Foo {
///   fn from(value: __rustbolt_napi_macros_Foo) -> Self {
///      // ..
///   }
/// }
///
...
///       let item: __rustbolt_napi_macros_Foo  = val.into();
///       item.into()
///    }
/// }
/// ```

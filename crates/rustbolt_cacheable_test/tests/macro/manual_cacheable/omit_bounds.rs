use dashmap::DashMap;
use rustbolt_cacheable::{from_bytes, to_bytes, with::AsMap};
...
#[rkyv(deserialize_bounds(
      __D: rustbolt_cacheable::__private::rkyv::rancor::Fallible<Error = rustbolt_cacheable::DeserializeError>
    ))]
#[rkyv(bytecheck(
    bounds(
        __C: rustbolt_cacheable::__private::rkyv::validation::ArchiveContext + rustbolt_cacheable::__private::rkyv::rancor::Fallible<Error = rustbolt_cacheable::DeserializeError>,
    )
  ))]
#[derive(Debug, Clone)]
struct Value {

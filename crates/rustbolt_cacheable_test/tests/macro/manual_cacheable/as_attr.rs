...
#[derive(
  rustbolt_cacheable::__private::rkyv::Archive, rustbolt_cacheable::__private::rkyv::Serialize,
)]
#[rkyv(crate=rustbolt_cacheable::__private::rkyv,
         as=rustbolt_cacheable::__private::rkyv::Archived<Data>)]
#[rkyv(serialize_bounds(
    __S: rustbolt_cacheable::__private::rkyv::ser::Writer + rustbolt_cacheable::__private::rkyv::ser::Allocator + rustbolt_cacheable::__private::rkyv::rancor::Fallible<Error = rustbolt_cacheable::SerializeError>,
    Inline: rustbolt_cacheable::__private::rkyv::with::SerializeWith<&'a String, __S>,
    AsVec<AsTuple2<Inline, AsOption<Inline>>>: rustbolt_cacheable::__private::rkyv::with::SerializeWith<Vec<(&'a String, Option<&'a String>)>, __S>,
    Inline: rustbolt_cacheable::__private::rkyv::with::SerializeWith<&'a Box<dyn Module>, __S>
  ))]
struct DataRef<'a> {
  #[rkyv(omit_bounds)]
  #[rkyv(with=Inline)]

...
use rustbolt_error::{miette::IntoDiagnostic, Diagnostic, Result};
...
const PLUGIN_NAME: &str = "rustbolt.SwcJsMinimizerRustboltPlugin";
...
#[plugin]
#[derive(Debug)]
pub struct SwcJsMinimizerRustboltPlugin {
  options: PluginOptions,
}

impl SwcJsMinimizerRustboltPlugin {
  pub fn new(options: PluginOptions) -> Self {
    Self::new_inner(options)
  }
}

#[plugin_hook(CompilerCompilation for SwcJsMinimizerRustboltPlugin)]
...
#[plugin_hook(JavascriptModulesChunkHash for SwcJsMinimizerRustboltPlugin)]
...
#[plugin_hook(CompilationProcessAssets for SwcJsMinimizerRustboltPlugin, stage = Compilation::PROCESS_ASSETS_STAGE_OPTIMIZE_SIZE)]
...
impl Plugin for SwcJsMinimizerRustboltPlugin {

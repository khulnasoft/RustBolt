...
use rustbolt_core::{
  ...
  rustbolt_sources::{BoxSource, CachedSource, SourceExt},
...
async fn compilation(
  ...
  compilation.set_dependency_factory(
    DependencyType::ContextElement(rustbolt_core::ContextTypePrefix::Import),
    params.normal_module_factory.clone(),
  );
  compilation.set_dependency_factory(
    DependencyType::ContextElement(rustbolt_core::ContextTypePrefix::Normal),
    params.normal_module_factory.clone(),
  );

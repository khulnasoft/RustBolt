...
use rustbolt_collections::{Identifier, IdentifierSet};
use rustbolt_core::{
  property_access, rustbolt_sources::ReplacementEnforce, AsContextDependency, AsModuleDependency,
...
impl Dependency for ESMExportExpressionDependency {
  ...
  ) -> rustbolt_core::ConnectionState {
    rustbolt_core::ConnectionState::Bool(false)
  }

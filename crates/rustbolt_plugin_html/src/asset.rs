...
use rayon::prelude::*;
use rustbolt_core::{
  rustbolt_sources::{RawBufferSource, RawStringSource, SourceExt},
...
use rustbolt_util::infallible::ResultInfallibleExt;
use serde::{Deserialize, Serialize};
use sugar_path::SugarPath;

use crate::{
  config::{HtmlChunkSortMode, HtmlInject, HtmlRustboltPluginOptions, HtmlScriptLoading},
...
fn url_encode_path(file_path: &str) -> String {
  ...
  format!(
    ...
    query_string.cow_replace("&", "$$RUSTBOLT_URL_AMP$$")
  )
}

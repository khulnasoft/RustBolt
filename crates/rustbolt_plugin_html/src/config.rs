...
use rustbolt_core::{Compilation, PublicPath};
...
pub struct HtmlRustboltPluginBaseOptions {
...
#[derive(Serialize, Debug)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct HtmlRustboltPluginOptions {
  ...
  pub base: Option<HtmlRustboltPluginBaseOptions>,
}
...
impl Default for HtmlRustboltPluginOptions {
  fn default() -> HtmlRustboltPluginOptions {
...
impl HtmlRustboltPluginOptions {

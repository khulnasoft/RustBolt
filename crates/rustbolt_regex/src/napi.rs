...
use crate::RustboltRegex;

impl ValidateNapiValue for RustboltRegex {}

impl TypeName for RustboltRegex {
...
impl FromNapiValue for RustboltRegex {
...
impl ToNapiValue for RustboltRegex {

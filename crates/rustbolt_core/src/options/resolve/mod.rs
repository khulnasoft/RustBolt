...
pub type AliasMap = rustbolt_resolver::AliasValue;
pub type Alias = rustbolt_resolver::Alias;
...
impl From<TsconfigOptions> for rustbolt_resolver::TsconfigOptions {
  fn from(val: TsconfigOptions) -> Self {
    rustbolt_resolver::TsconfigOptions {
...
impl From<TsconfigReferences> for rustbolt_resolver::TsconfigReferences {
  fn from(val: TsconfigReferences) -> Self {
    match val {
      TsconfigReferences::Disabled => rustbolt_resolver::TsconfigReferences::Disabled,
      TsconfigReferences::Auto => rustbolt_resolver::TsconfigReferences::Auto,
      TsconfigReferences::Paths(paths) => {
        rustbolt_resolver::TsconfigReferences::Paths(paths.into_iter().map(Into::into).collect())
      }
    }
  }
}

...
use rustbolt_collections::{impl_item_ukey, Ukey, UkeySet};
use rustbolt_util::{atom::Atom, ext::DynHash};
...
pub struct ExportInfoData {
  ...
  /// This is rustbolt only variable, it is used to flag if the target has been initialized
  target_is_set: bool,

// use rustbolt_core::Bundle;
// use rustbolt_core::ChunkGraph;
...
pub fn build_chunk_graph(compilation: &mut Compilation) -> rustbolt_error::Result<()> {
...
#[instrument(skip_all)]
pub fn build_chunk_graph_new(compilation: &mut Compilation) -> rustbolt_error::Result<()> {

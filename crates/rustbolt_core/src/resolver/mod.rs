...
use regex::Regex;
use rustbolt_error::{Error, MietteExt};
use rustbolt_loader_runner::{DescriptionData, ResourceData};
use rustbolt_paths::{AssertUtf8, Utf8PathBuf};
use rustbolt_util::identifier::insert_zero_width_space_for_fragment;
...
1. add the extension `\".{suggestion_ext}\"` to `resolve.extensions` in your rustbolt configuration

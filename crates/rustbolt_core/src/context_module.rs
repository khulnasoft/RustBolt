...
use rustbolt_paths::{ArcPath, Utf8PathBuf};
use rustbolt_regex::RustboltRegex;
use rustbolt_sources::{BoxSource, ConcatSource, RawStringSource, SourceExt};
use rustbolt_util::{fx_hash::FxIndexMap, itoa, json_stringify, source_map::SourceMapKind};
...
pub struct ContextOptions {
  ...
  pub recursive: bool,
  pub reg_exp: Option<RustboltRegex>,
  pub include: Option<RustboltRegex>,
...
impl Module for ContextModule {
  ...
  fn source(&self) -> Option<&rustbolt_sources::BoxSource> {
    None
  }

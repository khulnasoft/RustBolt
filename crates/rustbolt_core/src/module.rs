...
use rustbolt_collections::{Identifiable, Identifier, IdentifierSet};
use rustbolt_error::{Diagnosable, Result};
...
mod test {
  ...
  use rustbolt_hash::RustboltHashDigest;
  use rustbolt_sources::BoxSource;
  use rustbolt_util::source_map::{ModuleSourceMapConfig, SourceMapKind};

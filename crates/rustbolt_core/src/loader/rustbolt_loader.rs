...
use rustbolt_loader_runner::{Content, LoaderContext, LoaderRunnerPlugin, ResourceData};

use crate::{RunnerContext, SharedPluginDriver};

pub struct RustboltLoaderRunnerPlugin {
  pub plugin_driver: SharedPluginDriver,
  pub current_loader: Mutex<Option<String>>,
}

#[async_trait::async_trait]
impl LoaderRunnerPlugin for RustboltLoaderRunnerPlugin {
  type Context = RunnerContext;

  fn name(&self) -> &'static str {
    "rustbolt-loader-runner"
  }

use rustbolt_fs::{Result, WritableFileSystem};
...
///   use crate::{
///     rustbolt_fs::{ReadableFileSystem, WritableFileSystem, WritableFileSystemExt},
///     rustbolt_paths::Utf8Path,
///   };
///   let fs = crate::rustbolt_fs::NativeFileSystem;
///
...
#[cfg(test)]
mod test {
  use rustbolt_fs::{MemoryFileSystem, WritableFileSystem};
  use rustbolt_paths::Utf8Path;

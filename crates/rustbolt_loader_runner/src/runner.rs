...
use rustbolt_error::{error, IntoTWithDiagnosticArray, Result, TWithDiagnosticArray};
use rustbolt_fs::ReadableFileSystem;
use rustbolt_sources::SourceMap;
...
Rustbolt supports "data:" and "file:" URIs by default.
...
mod test {
  ...
  use rustbolt_fs::NativeFileSystem;
  ...
  async fn should_have_the_right_execution_order() {
    ...
    impl Identifiable for Pitching {
      fn identifier(&self) -> Identifier {
        "/rustbolt/pitching-loader1".into()
      }
    }
    ...
    impl Identifiable for Pitching2 {
      fn identifier(&self) -> Identifier {
        "/rustbolt/pitching-loader2".into()
      }
    }
    ...
    impl Identifiable for PitchNormalBase {
      fn identifier(&self) -> Identifier {
        "/rustbolt/pitch-normal-base-loader".into()
      }
    }
    ...
    impl Identifiable for PitchNormal {
      fn identifier(&self) -> Identifier {
        "/rustbolt/pitch-normal-loader".into()
      }
    }
    ...
    impl Identifiable for PitchNormal2 {
      fn identifier(&self) -> Identifier {
        "/rustbolt/pitch-normal-2-loader".into()
      }
    }
    ...
    let rs = Arc::new(ResourceData {
      scheme: OnceCell::new(),
      resource: "/rustbolt/main.js?abc=123#efg".to_owned(),

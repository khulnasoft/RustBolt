...
impl Content {
  pub fn try_into_string(self) -> Result<String> {
    match self {
      ...
      Content::Buffer(b) => String::from_utf8(b).map_err(|e| rustbolt_error::error!(e.to_string())),
    }
  }
...
/// Used for [Rule.descriptionData](https://www.rustbolt.dev/config/module.html#ruledescriptiondata) and

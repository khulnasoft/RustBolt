...
use rustbolt_util::{asset_condition::AssetConditions, infallible::ResultInfallibleExt as _};
...
async fn process_assets(&self, compilation: &mut Compilation) -> Result<()> {
  let logger = compilation.get_logger("rustbolt.BannerPlugin");

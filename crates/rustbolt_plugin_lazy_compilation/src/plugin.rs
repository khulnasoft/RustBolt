...
static WEBPACK_DEV_SERVER_CLIENT_RE: LazyLock<RustboltRegex> = LazyLock::new(|| {
  RustboltRegex::new(
    r#"(webpack|rustbolt)[/\\]hot[/\\]|(webpack|rustbolt)-dev-server[/\\]client|(webpack|rustbolt)-hot-middleware[/\\]client"#,
  )

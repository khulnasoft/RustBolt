...
use rustbolt_core::{
  rustbolt_sources::{BoxSource, RawStringSource, Source, SourceExt},
...
use rustbolt_error::{Diagnostic, IntoTWithDiagnosticArray, Result, TWithDiagnosticArray};
use rustbolt_util::{infallible::ResultInfallibleExt as _, itoa};
...
",
  ...
  fn get_concatenation_bailout_reason(
    &self,
    _module: &dyn Module,
    _mg: &rustbolt_core::ModuleGraph,
    _cg: &rustbolt_core::ChunkGraph,

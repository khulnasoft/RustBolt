...
use rustbolt_swc_plugin_import::{ImportOptions, RawImportOptions};
...
pub struct RawRustboltExperiments {
  pub import: Option<Vec<RawImportOptions>>,
}

#[derive(Default, Debug)]
pub(crate) struct RustboltExperiments {
  pub(crate) import: Option<Vec<ImportOptions>>,
}

impl From<RawRustboltExperiments> for RustboltExperiments {
  fn from(value: RawRustboltExperiments) -> Self {
    Self {
      import: value
        .import
...
pub struct SwcLoaderJsOptions {
  ...
  #[serde(default)]
  pub rustbolt_experiments: Option<RawRustboltExperiments>,
}
...
pub(crate) struct SwcCompilerOptionsWithAdditional {
  ...
  pub(crate) rustbolt_experiments: RustboltExperiments,
}
...
impl TryFrom<&str> for SwcCompilerOptionsWithAdditional {
  ...
  fn try_from(value: &str) -> Result<Self, Self::Error> {
    ...
    Ok(SwcCompilerOptionsWithAdditional {
      ...
      rustbolt_experiments: rustbolt_experiments.unwrap_or_default().into(),
    })
  }
}

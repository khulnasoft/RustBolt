...
let __wasmFilePath = __nodePath.join(__dirname, 'rustbolt.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'rustbolt.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  try {
    __wasmFilePath = __nodePath.resolve('@rustbolt/binding-wasm32-wasi')
  } catch {
    throw new Error('Cannot find rustbolt.wasm32-wasi.wasm file, and @rustbolt/binding-wasm32-wasi package is not installed.')
  }
}
...
module.exports.JsRustboltSeverity = __napiModule.exports.JsRustboltSeverity

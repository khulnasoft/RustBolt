...
export declare class JsCompilation {
  ...
  pushDiagnostic(diagnostic: JsRustboltDiagnostic): void
  spliceDiagnostic(start: number, end: number, replaceWith: Array<JsRustboltDiagnostic>): void
  pushNativeDiagnostic(diagnostic: ExternalObject<'Diagnostic'>): void
  pushNativeDiagnostics(diagnostics: ExternalObject<'Diagnostic[]'>): void
  getErrors(): Array<JsRustboltError>
  getWarnings(): Array<JsRustboltError>
  getStats(): JsStats
...
export declare enum BuiltinPluginName {
  ...
  HttpExternalsRustboltPlugin = 'HttpExternalsRustboltPlugin',
  CopyRustboltPlugin = 'CopyRustboltPlugin',
  HtmlRustboltPlugin = 'HtmlRustboltPlugin',
  SwcJsMinimizerRustboltPlugin = 'SwcJsMinimizerRustboltPlugin',
  LightningCssMinimizerRustboltPlugin = 'LightningCssMinimizerRustboltPlugin',
  BundlerInfoRustboltPlugin = 'BundlerInfoRustboltPlugin',
  CssExtractRustboltPlugin = 'CssExtractRustboltPlugin',
  SubresourceIntegrityPlugin = 'SubresourceIntegrityPlugin',
  RsdoctorPlugin = 'RsdoctorPlugin',
  CircularDependencyRustboltPlugin = 'CircularDependencyRustboltPlugin',
  JsLoaderRustboltPlugin = 'JsLoaderRustboltPlugin',
...
export interface JsLoaderContext {
  ...
  __internal__error?: JsRustboltError
...
export interface JsRustboltDiagnostic {
  severity: JsRustboltSeverity
  error: JsRustboltError
}

export interface JsRustboltError {
  name: string
  message: string
  moduleIdentifier?: string
  loc?: string
...
export declare enum JsRustboltSeverity {
  Error = 'Error',
  Warn = 'Warn'
}
...
export interface RawCircularDependencyRustboltPluginOptions {
  failOnError?: boolean
...
export interface RawCopyRustboltPluginOptions {
...
rustboltFuture?: RawRustboltFuture
...
export interface RawHtmlRustboltPluginBaseOptions {
  href?: string
  target?: "_self" | "_blank" | "_parent" | "_top"
}

export interface RawHtmlRustboltPluginOptions {
  ...
  hash?: boolean
  base?: RawHtmlRustboltPluginBaseOptions
}

export interface RawHttpExternalsRustboltPluginOptions {
  css: boolean
  webAsync: boolean
}
...
export interface RawLightningCssMinimizerRustboltPluginOptions {
  test?: string | RegExp | (string | RegExp)[]
  include?: string | RegExp | (string | RegExp)[]
  exclude?: string | RegExp | (string | RegExp)[]
...
export interface RawModuleRule {
   ...
   */
  rustboltResource?: RawRuleSetCondition
...
export interface RawRustboltFuture {
...
export interface RawSwcJsMinimizerRustboltPluginOptions {
  test?: string | RegExp | (string | RegExp)[]
  include?: string | RegExp | (string | RegExp)[]
  exclude?: string | RegExp | (string | RegExp)[]

...
use rustbolt_core::DependenciesBlock as _;
use rustbolt_napi::{napi::bindgen_prelude::*, OneShotRef};
...
pub struct AsyncDependenciesBlock {
  pub(crate) block_id: rustbolt_core::AsyncDependenciesBlockIdentifier,
  compilation: NonNull<rustbolt_core::Compilation>,
}
...
type BlockInstanceRefs = HashMap<rustbolt_core::AsyncDependenciesBlockIdentifier, OneShotRef>;

type BlockInstanceRefsByCompilationId =
  RefCell<HashMap<rustbolt_core::CompilationId, BlockInstanceRefs>>;
...
pub struct AsyncDependenciesBlockWrapper {
  block_id: rustbolt_core::AsyncDependenciesBlockIdentifier,
  compilation: NonNull<rustbolt_core::Compilation>,
}

impl AsyncDependenciesBlockWrapper {
  pub fn new(
    block: &rustbolt_core::AsyncDependenciesBlock,
    ...
    Self {
      ...
      compilation: NonNull::new(
        compilation as *const rustbolt_core::Compilation as *mut rustbolt_core::Compilation,
      )
      .unwrap(),
    }
  }

  pub fn cleanup_last_compilation(compilation_id: rustbolt_core::CompilationId) {

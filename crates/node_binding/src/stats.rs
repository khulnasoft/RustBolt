...
use rustbolt_core::{
  rustbolt_sources::{RawBufferSource, RawSource, Source},
...
impl From<rustbolt_core::StatsError<'_>> for JsStatsError {
  fn from(stats: rustbolt_core::StatsError) -> Self {
    Self {
...
impl From<rustbolt_core::StatsWarning<'_>> for JsStatsWarning {
  fn from(stats: rustbolt_core::StatsWarning) -> Self {
    Self {
      module_descriptor: stats.module_identifier.map(|identifier| {
        JsModuleDescriptor {
          identifier: identifier.into(),
...
impl From<rustbolt_core::StatsModuleTrace> for JsStatsModuleTrace {
  fn from(stats: rustbolt_core::StatsModuleTrace) -> Self {
    Self {
...
impl From<rustbolt_core::StatsErrorModuleTraceModule> for JsStatsModuleTraceModule {
  fn from(stats: rustbolt_core::StatsErrorModuleTraceModule) -> Self {
    Self {
...
impl From<rustbolt_core::StatsErrorModuleTraceDependency> for JsStatsModuleTraceDependency {
  fn from(stats: rustbolt_core::StatsErrorModuleTraceDependency) -> Self {
    Self { loc: stats.loc }
  }
}
...
impl From<(String, rustbolt_core::LogType)> for JsStatsLogging {
  fn from(value: (String, rustbolt_core::LogType)) -> Self {
    match value.1 {
      rustbolt_core::LogType::Error { message, trace } => Self {
        name: value.0,
        r#type: "error".to_string(),
        args: Some(vec![message]),
        trace: Some(trace),
      },
      rustbolt_core::LogType::Warn { message, trace } => Self {
        name: value.0,
        r#type: "warn".to_string(),
        args: Some(vec![message]),
        trace: Some(trace),
      },
      rustbolt_core::LogType::Info { message } => Self {
        name: value.0,
        r#type: "info".to_string(),
        args: Some(vec![message]),
        trace: None,
      },
      rustbolt_core::LogType::Log { message } => Self {
        name: value.0,
        r#type: "log".to_string(),
        args: Some(vec![message]),
        trace: None,
      },
      rustbolt_core::LogType::Debug { message } => Self {
        name: value.0,
        r#type: "debug".to_string(),
        args: Some(vec![message]),
        trace: None,
      },
      rustbolt_core::LogType::Trace { message, trace } => Self {
        name: value.0,
        r#type: "trace".to_string(),
        args: Some(vec![message]),
        trace: Some(trace),
      },
      rustbolt_core::LogType::Group { message } => Self {
        name: value.0,
        r#type: "group".to_string(),
        args: Some(vec![message]),
        trace: None,
      },
      rustbolt_core::LogType::GroupCollapsed { message } => Self {
        name: value.0,
        r#type: "groupCollapsed".to_string(),
        args: Some(vec![message]),
        trace: None,
      },
      rustbolt_core::LogType::GroupEnd => Self {
        name: value.0,
        r#type: "groupEnd".to_string(),
        args: None,
        trace: None,
      },
      rustbolt_core::LogType::Profile { label } => Self {
        name: value.0,
        r#type: "profile".to_string(),
        args: Some(vec![label.to_string()]),
        trace: None,
      },
      rustbolt_core::LogType::ProfileEnd { label } => Self {
        name: value.0,
        r#type: "profileEnd".to_string(),
        args: Some(vec![label.to_string()]),
        trace: None,
      },
      rustbolt_core::LogType::Time {
        label,
        secs,
        subsec_nanos,
      } => Self {
      ...
      rustbolt_core::LogType::Clear => Self {
        name: value.0,
        r#type: "clear".to_string(),
        args: None,
        trace: None,
      },
      rustbolt_core::LogType::Status { message } => Self {
        name: value.0,
        r#type: "status".to_string(),
        args: Some(vec![message]),
        trace: None,
      },
      rustbolt_core::LogType::Cache { label, hit, total } => Self {
        name: value.0,
...
impl From<rustbolt_core::StatsAsset> for JsStatsAsset {
  fn from(stats: rustbolt_core::StatsAsset) -> Self {
    Self {
      r#type: stats.r#type,
      name: stats.name,
      size: stats.size,
...
impl From<rustbolt_core::StatsAssetInfo> for JsStatsAssetInfo {
  fn from(stats: rustbolt_core::StatsAssetInfo) -> Self {
    Self {
...
impl From<rustbolt_core::StatsAssetInfoRelated> for JsStatsAssetInfoRelated {
  fn from(stats: rustbolt_core::StatsAssetInfoRelated) -> Self {
    Self {
      name: stats.name,
      value: stats.value,
    }
...
impl From<rustbolt_core::StatsModuleProfile> for JsStatsModuleProfile {
  fn from(value: rustbolt_core::StatsModuleProfile) -> Self {
    Self {
...
impl From<rustbolt_core::StatsMillisecond> for JsStatsMillisecond {
  fn from(value: rustbolt_core::StatsMillisecond) -> Self {
    Self {
...
impl From<rustbolt_core::StatsModuleIssuer<'_>> for JsStatsModuleIssuer {
  fn from(stats: rustbolt_core::StatsModuleIssuer) -> Self {
    Self {
      module_descriptor: JsModuleDescriptor {
        identifier: stats.identifier.into(),
...
impl From<rustbolt_core::StatsModuleReason<'_>> for JsStatsModuleReason {
  fn from(stats: rustbolt_core::StatsModuleReason) -> Self {
    Self {
      module_descriptor: stats.module_identifier.map(|identifier| {
        JsModuleDescriptor {
          identifier: identifier.into(),
...
impl From<rustbolt_core::StatsChunkGroupAsset> for JsStatsChunkGroupAsset {
  fn from(stats: rustbolt_core::StatsChunkGroupAsset) -> Self {
    Self {
      name: stats.name,
...
impl From<rustbolt_core::StatsChunkGroup> for JsStatsChunkGroup {
  fn from(stats: rustbolt_core::StatsChunkGroup) -> Self {
    Self {
      name: stats.name,
      chunks: stats.chunks,
...
impl From<rustbolt_core::StatschunkGroupChildAssets> for JsStatsChildGroupChildAssets {
  fn from(stats: rustbolt_core::StatschunkGroupChildAssets) -> Self {
    Self {
...
impl From<rustbolt_core::StatsChunkGroupChildren> for JsStatsChunkGroupChildren {
  fn from(stats: rustbolt_core::StatsChunkGroupChildren) -> Self {
    Self {
...
impl From<rustbolt_core::StatsAssetsByChunkName> for JsStatsAssetsByChunkName {
  fn from(stats: rustbolt_core::StatsAssetsByChunkName) -> Self {
    Self {
      name: stats.name,
      files: stats.files,
    }

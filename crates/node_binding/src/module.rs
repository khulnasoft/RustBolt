...
pub struct Module {
  ...
  module: Option<NonNull<dyn rustbolt_core::Module>>,
...
impl Module {
  ...
  pub(crate) fn as_ref(&mut self) -> napi::Result<(&Compilation, &dyn rustbolt_core::Module)> {
  ...
  pub(crate) fn as_mut(&mut self) -> napi::Result<&'static mut dyn rustbolt_core::Module> {
    match self.module.as_mut() {
      ...
      None => Err(napi::Error::from_reason(format!(
        "Unable to modify module with id = {}. Currently, you can only modify the module in the loader in Rustbolt.",
        self.identifier
      ))),
    }
  }
...
impl ModuleObject {
  pub fn with_ref(module: &dyn rustbolt_core::Module, compiler_id: CompilerId) -> Self {
    Self {
  ...
  pub fn with_ptr(module_ptr: NonNull<dyn rustbolt_core::Module>, compiler_id: CompilerId) -> Self {
  ...
  pub fn take(&mut self) -> Option<NonNull<dyn rustbolt_core::Module>> {
    self.module
  }
}
        ...
        std::collections::hash_map::Entry::Vacant(entry) => {
          match COMPILER_REFERENCES.with(|ref_cell| {
            ...
            Some(compiler_reference) => {
              ...
              let instance_ref = if val.type_id == TypeId::of::<rustbolt_core::NormalModule>() {
              ...
              } else if val.type_id == TypeId::of::<rustbolt_core::ConcatenatedModule>() {
              ...
              } else if val.type_id == TypeId::of::<rustbolt_core::ContextModule>() {
              ...
              } else if val.type_id == TypeId::of::<rustbolt_core::ExternalModule>() {
  ...
  unsafe fn from_napi_value(env: sys::napi_env, napi_val: sys::napi_value) -> Result<Self> {
    ...
    Ok(match instance {
      Either5::A(normal_module) => Self {
        type_id: TypeId::of::<rustbolt_core::NormalModule>(),
      ...
      Either5::B(concatenated_module) => Self {
        type_id: TypeId::of::<rustbolt_core::ConcatenatedModule>(),
      ...
      Either5::C(context_module) => Self {
        type_id: TypeId::of::<rustbolt_core::ContextModule>(),
      ...
      Either5::E(module) => Self {
        type_id: TypeId::of::<dyn rustbolt_core::Module>(),
        identifier: module.identifier,

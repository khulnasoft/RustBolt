...
use rustbolt_napi::string::JsStringExt;
use rustbolt_napi_macros::field_names;
...
impl From<JsAssetInfoRelated> for rustbolt_core::AssetInfoRelated {
...
impl From<AssetInfo> for rustbolt_core::AssetInfo {
...
impl From<rustbolt_core::AssetInfoRelated> for JsAssetInfoRelated {
  fn from(related: rustbolt_core::AssetInfoRelated) -> Self {
    Self {
...
impl From<rustbolt_core::AssetInfo> for AssetInfo {
  fn from(value: rustbolt_core::AssetInfo) -> Self {
    let rustbolt_core::AssetInfo {
      immutable,
      minimized,
      full_hash,
      chunk_hash,

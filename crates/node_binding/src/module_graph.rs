...
use rustbolt_core::{Compilation, ModuleGraph, RuntimeSpec};
...
impl JsModuleGraph {
  ...
  pub fn get_used_exports(
    ...
    Ok(match used_exports {
      rustbolt_core::UsedExports::Null => None,
      rustbolt_core::UsedExports::Bool(b) => Some(Either::A(b)),
      rustbolt_core::UsedExports::Vec(vec) => Some(Either::B(
        vec
          .into_iter()

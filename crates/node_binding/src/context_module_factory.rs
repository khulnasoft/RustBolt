...
use rustbolt_core::{AfterResolveData, BeforeResolveData};
...
impl JsContextModuleFactoryBeforeResolveData {
  ...
  pub fn reg_exp(&self) -> Either<RustboltRegex, ()> {
  ...
  pub fn set_reg_exp(&mut self, raw_reg_exp: Either<RustboltRegex, ()>) {

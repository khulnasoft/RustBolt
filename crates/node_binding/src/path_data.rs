...
impl JsPathData {
  pub fn from_path_data(path_data: rustbolt_core::PathData) -> JsPathData {
    Self {
  ...
  pub fn to_path_data(&self) -> rustbolt_core::PathData {
    rustbolt_core::PathData {
...
impl From<(String, rustbolt_core::AssetInfo)> for PathWithInfo {
  fn from(value: (String, rustbolt_core::AssetInfo)) -> Self {
    Self {
      path: value.0,
      info: value.1.into(),
    }

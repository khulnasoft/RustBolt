...
use rustbolt_hook::{Hook, Interceptor};
use rustbolt_napi::threadsafe_function::ThreadsafeFunction;
use rustbolt_paths::Utf8PathBuf;
...
use rustbolt_plugin_javascript::{JavascriptModulesChunkHash, JavascriptModulesChunkHashHook};
use rustbolt_plugin_rsdoctor::{
...
impl<T: 'static + ToNapiValue, R: 'static + FromNapiValue> RegisterJsTapsInner<T, R> {
  ...
  pub async fn call_register(
    &self,
    hook: &impl Hook,
  ) -> rustbolt_error::Result<RegisterFunctionOutput<T, R>> {
  ...
  (@INTERCEPTOR $name:ident, $tap_name:ident, $tap_hook:ty, $cache:literal, $kind:expr) => {
    ...
    impl Interceptor<$tap_hook> for $name {
      async fn call(
        &self,
        hook: &$tap_hook,
      ) -> rustbolt_error::Result<Vec<<$tap_hook as Hook>::Tap>> {
...
impl CompilerMake for CompilerMakeTap {
  async fn run(&self, compilation: &mut Compilation) -> rustbolt_error::Result<()> {
    let compilation = JsCompilationWrapper::new(compilation);
...
impl CompilerShouldEmit for CompilerShouldEmitTap {
  async fn run(&self, compilation: &mut Compilation) -> rustbolt_error::Result<Option<bool>> {
    let compilation = JsCompilationWrapper::new(compilation);
    self.function.call_with_sync(compilation).await
  }
...
impl CompilerEmit for CompilerEmitTap {
  async fn run(&self, _compilation: &mut Compilation) -> rustbolt_error::Result<()> {
...
impl CompilationOptimizeModules for CompilationOptimizeModulesTap {
  async fn run(&self, _compilation: &mut Compilation) -> rustbolt_error::Result<Option<bool>> {
...
impl NormalModuleFactoryBeforeResolve for NormalModuleFactoryBeforeResolveTap {
  async fn run(&self, data: &mut ModuleFactoryCreateData) -> rustbolt_error::Result<Option<bool>> {
...
impl NormalModuleFactoryFactorize for NormalModuleFactoryFactorizeTap {
  ...
  ) -> rustbolt_error::Result<Option<BoxModule>> {
    let dependency = data.dependencies[0]
      .as_module_dependency_mut()
      .expect("should be module dependency");
    match self
...
impl NormalModuleFactoryResolve for NormalModuleFactoryResolveTap {
  async fn run(
    &self,
    data: &mut ModuleFactoryCreateData,
  ) -> rustbolt_error::Result<Option<NormalModuleFactoryResolveResult>> {
    let dependency = data.dependencies[0]
      .as_module_dependency_mut()
      .expect("should be module dependency");
    match self
...
impl ContextModuleFactoryBeforeResolve for ContextModuleFactoryBeforeResolveTap {
  async fn run(&self, result: BeforeResolveResult) -> rustbolt_error::Result<BeforeResolveResult> {
...
impl ContextModuleFactoryAfterResolve for ContextModuleFactoryAfterResolveTap {
  async fn run(&self, result: AfterResolveResult) -> rustbolt_error::Result<AfterResolveResult> {
    let js_result = match result {
...
impl HtmlPluginBeforeAssetTagGeneration for HtmlPluginBeforeAssetTagGenerationTap {
  ...
  ) -> rustbolt_error::Result<BeforeAssetTagGenerationData> {
    let result = self
      .function
...
impl HtmlPluginAlterAssetTags for HtmlPluginAlterAssetTagsTap {
  async fn run(&self, data: AlterAssetTagsData) -> rustbolt_error::Result<AlterAssetTagsData> {
    let result = self
      .function
...
impl HtmlPluginAlterAssetTagGroups for HtmlPluginAlterAssetTagGroupsTap {
  ...
  ) -> rustbolt_error::Result<AlterAssetTagGroupsData> {
    let result = self
      .function
...
impl HtmlPluginAfterTemplateExecution for HtmlPluginAfterTemplateExecutionTap {
  ...
  ) -> rustbolt_error::Result<AfterTemplateExecutionData> {
    let result = self
      .function
...
impl HtmlPluginBeforeEmit for HtmlPluginBeforeEmitTap {
  async fn run(&self, data: BeforeEmitData) -> rustbolt_error::Result<BeforeEmitData> {
    let result = self
      .function
...
impl HtmlPluginAfterEmit for HtmlPluginAfterEmitTap {
  async fn run(&self, data: AfterEmitData) -> rustbolt_error::Result<AfterEmitData> {
    let result = self
      .function
...
impl RuntimePluginCreateScript for RuntimePluginCreateScriptTap {
  async fn run(&self, mut data: CreateScriptData) -> rustbolt_error::Result<CreateScriptData> {
...
impl RuntimePluginLinkPreload for RuntimePluginLinkPreloadTap {
  async fn run(&self, mut data: LinkPreloadData) -> rustbolt_error::Result<LinkPreloadData> {
    if let Some(code) = self
      .function
...
impl RuntimePluginLinkPrefetch for RuntimePluginLinkPrefetchTap {
  async fn run(&self, mut data: LinkPrefetchData) -> rustbolt_error::Result<LinkPrefetchData> {
    if let Some(code) = self
      .function
...
impl RsdoctorPluginModuleGraph for RsdoctorPluginModuleGraphTap {
  async fn run(&self, data: &mut RsdoctorModuleGraph) -> rustbolt_error::Result<Option<bool>> {
...
impl RsdoctorPluginChunkGraph for RsdoctorPluginChunkGraphTap {
  async fn run(&self, data: &mut RsdoctorChunkGraph) -> rustbolt_error::Result<Option<bool>> {
    let data = std::mem::take(data);
    let bail = self
      .function
...
impl RsdoctorPluginModuleIds for RsdoctorPluginModuleIdsTap {
  async fn run(&self, data: &mut RsdoctorModuleIdsPatch) -> rustbolt_error::Result<Option<bool>> {
    let data = std::mem::take(data);
    let bail = self
      .function
...
impl RsdoctorPluginAssets for RsdoctorPluginAssetsTap {
  async fn run(&self, data: &mut RsdoctorAssetPatch) -> rustbolt_error::Result<Option<bool>> {
    let data = std::mem::take(data);
    let bail = self
      .function

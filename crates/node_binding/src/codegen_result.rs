...
use rustbolt_core::{get_runtime_key, CodeGenerationResult, CodeGenerationResults};
      ...
      map: map
        ...
        .map(|(module_id, runtime_result_map)| {
          ...
          match &runtime_result_map.mode {
            rustbolt_core::RuntimeMode::Empty => {}
            rustbolt_core::RuntimeMode::SingleEntry => {
              runtime_map.insert(

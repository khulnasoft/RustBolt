...
use rustbolt_core::rustbolt_sources::RawSource;
use rustbolt_napi::threadsafe_function::ThreadsafeFunction;
use rustbolt_plugin_copy::{
  CopyGlobOptions, CopyPattern, CopyRustboltPluginOptions, Info, Related, ToOption, ToType,
  Transformer,
};
...
#[derive(Debug)]
#[napi(object, object_to_js = false)]
pub struct RawCopyRustboltPluginOptions {
...
impl From<RawCopyRustboltPluginOptions> for CopyRustboltPluginOptions {
  fn from(val: RawCopyRustboltPluginOptions) -> Self {
    Self {

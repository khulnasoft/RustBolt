...
use rustbolt_plugin_circular_dependencies::{
  CircularDependencyIgnoredConnection, CircularDependencyIgnoredConnectionEntry,
  CircularDependencyRustboltPluginOptions, CompilationHookFn, CycleHandlerFn,
};
...
fn ignore_pattern_to_entry(
  pattern: Either<String, RustboltRegex>,
...
type ConnectionPattern = Either<String, RustboltRegex>;
type CycleHookParams = (String, Vec<String>, JsCompilationWrapper);

#[derive(Debug)]
#[napi(object, object_to_js = false)]
pub struct RawCircularDependencyRustboltPluginOptions {
...
impl From<RawCircularDependencyRustboltPluginOptions> for CircularDependencyRustboltPluginOptions {
  fn from(value: RawCircularDependencyRustboltPluginOptions) -> Self {

...
use rustbolt_core::{MangleExportsOption, Optimization, SideEffectOption, UsedExportsOption};
...
impl TryFrom<RawOptimizationOptions> for Optimization {
  ...
  fn try_from(value: RawOptimizationOptions) -> rustbolt_error::Result<Self> {
    Ok(Optimization {

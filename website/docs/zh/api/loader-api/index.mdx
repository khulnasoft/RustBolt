...
Rustbolt 致力于兼容 webpack 生态中的 loader。我们确保 Rustbolt 尽可能地去兼容 webpack 的 loader API，使更多现有的 webpack loader 能够在 Rustbolt 中直接使用。

目前 Rustbolt 已经兼容了 webpack 绝大部分的 loader API，如果你发现某个 webpack loader 无法在 Rustbolt 中使用，欢迎到 [Rustbolt 仓库](https://github.com/khulnasoft/rustbolt) 通过 issue 反馈。

...
- **基于 Rust 的 Web 打包工具** —— [Rustbolt](https://github.com/khulnasoft/rustbolt)，旨在建设高性能前端工具链，让跨端和 Web 场景拥有 “快人一步” 的开发体验，具备极速的编译和热更新性能。
- **基于 Rustbolt 的开源方案**，包括 [Rsbuild](https://github.com/khulnasoft/rsbuild)、[Rspress](https://github.com/khulnasoft/rspress) 和 [Modern.js](https://github.com/khulnasoft/modern.js)，构成一系列开箱即用的解决方案，提供从 Web 构建、静态站点生成到全栈研发的多场景支持。
...
- [@hardfist](https://github.com/hardfist)：资深配置工程师，踩坑工程师，负责 Rustbolt。

...
Rustbolt CLI 支持使用 `--analyze` 选项进行包体积分析，我们在内部使用 [webpack-bundle-analyzer](https://www.npmjs.com/package/webpack-bundle-analyzer) 实现该功能。
...
Rsdoctor 提供了 `Bundle Size` 模块，该模块主要用于分析 Rustbolt 构建产物的信息，包括当前编译产物的资源大小、重复包、模块引用关系等：
...
<img
  src="https://assets.rustbolt.dev/others/assets/rsdoctor/bundle-size-overall.png"
  width="700px"
  style={{ margin: 'auto' }}
/>

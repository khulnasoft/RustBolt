...
While using Rustbolt, you can use the following command to generate a JSON file of the statistics module information to analyze the module dependency relationship:
...
type StatsCompilation = {
  ...
  version?: string;
  // Current version number of rustbolt
  ...
  publicPath?: string;
  // Path to rustbolt output directory
  outputPath?: string;
...
type StatsChunk = {
  ...
  // Chunk hash
  hash?: string;
  // Whether the chunk contains the rustbolt runtime
  entry: boolean;

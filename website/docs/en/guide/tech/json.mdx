...
[JSON](https://en.wikipedia.org/wiki/JSON) is a first-class citizen with Rustbolt. You can import it directly, for example:
...
Rustbolt supports [import attributes](https://github.com/tc39/proposal-import-attributes), and you can use import attributes to import JSON:

...
We are grateful for your interest in contributing to Rustbolt!
Every single contribution counts and helps us take Rustbolt to the next level.

## Asking questions

If you have any questions,
please do not hesitate to ask either in the [Discord](https://discord.gg/sYK4QjyZ4V) support channel or on the [GitHub discussion board](https://github.com/khulnasoft/rustbolt/discussions).

### Minimal reproduction

The [Rustbolt repro template](https://github.com/khulnasoft/rustbolt-repro) can be used to create a minimal reproducible example.
...
we recommend checking out our issue list labeled with [good first issue](https://github.com/khulnasoft/rustbolt/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3A%22good+first+issue%22).
...
our [tracking issues list](https://github.com/khulnasoft/rustbolt/issues?q=is%3Aopen+label%3A%22tracking+issue%22+sort%3Aupdated-desc)
provides an overview of our progress and current goals.

## Sending pull request

1. [Fork](https://help.github.com/articles/fork-a-repo/) the Rustbolt repository into your own GitHub account.
...
If your PR contains any breaking changes, please append a `!` after the type/scope, then add the [release: breaking change](https://github.com/khulnasoft/rustbolt/labels) GitHub label.
...
- The documentation site is at [khulnasoft/rustbolt/website](https://github.com/khulnasoft/rustbolt/tree/main/website)
- The community packages are at [github.com/rustbolt-contrib](https://github.com/rustbolt-contrib)
- Welcome to add Rustbolt related projects to [awesome-rustbolt](https://github.com/khulnasoft/awesome-rustbolt)

---

As a reminder, all contributors are expected to follow our [Code of Conduct](https://github.com/khulnasoft/rustbolt/blob/main/CODE_OF_CONDUCT.md).

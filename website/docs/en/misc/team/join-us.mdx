...
- **Rust-based Web build tool** — [Rustbolt](https://github.com/khulnasoft/rustbolt), aimed at building a high-performance front-end toolchain, providing cross-platform and Web scenarios with a "one step ahead" development experience, featuring extremely fast compilation and hot update performance.
- **Open source solutions based on Rustbolt**, including [Rsbuild](https://github.com/khulnasoft/rsbuild), [Rspress](https://github.com/khulnasoft/rspress), and [Modern.js](https://github.com/khulnasoft/modern.js), forming a series of ready-to-use solutions, offering multi-scenario support from Web building, static site generation to full-stack research and development.
...
![](https://assets.rustbolt.dev/others/assets/jd-location-2023.png)
...
- [@hardfist](https://github.com/hardfist): Senior configuration engineer, pitfall troubleshooter, responsible for Rustbolt.

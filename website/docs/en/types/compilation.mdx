...
type Compilation = {
  ...
  options: RustboltOptionsNormalized; // the compiler options
  ...
  errors: RustboltError[]; // errors during compilation
  warnings: RustboltError[]; // warnings during compilation
};
```
